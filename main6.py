...
/* Sidebar collapse/expand button we put inside the sidebar */
...
with st.sidebar:
    ...
    st.markdown("""
    <div style="padding:22px 22px 16px; border-bottom:1px solid rgba(255,255,255,0.10);">
      <img
    ...
    st.markdown(
        "<hr style='border:none; border-top:1px solid rgba(255,255,255,0.10); margin:0 0 14px;'>",
        unsafe_allow_html=True,
    )
