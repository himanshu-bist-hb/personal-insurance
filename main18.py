...
[data-testid="stSidebar"] > div:first-child {
  padding: 0 !important;
  background: #F7F9FC !important;
  gap: 0 !important;                /* kills spacing between every sidebar element */
}

/* Every direct child element wrapper inside the sidebar — zero gap */
...
/* stVerticalBlock is Streamlit's inner flex column — zero its gap */
...
/* Each element wrapper (stMarkdown, stImage, stRadio etc.) */
...
/* ── st.image: zero all wrappers, padding lives on the img itself ── */
...
/* Zero ALL wrappers — this kills the grey bar above Business Auto */
[data-testid="stSidebar"] [data-testid="stRadio"] { padding:0 !important; margin:0 !important; }
[data-testid="stSidebar"] [data-testid="stRadio"] > div { gap:0 !important; padding:0 !important; margin:0 !important; }
[data-testid="stSidebar"] [data-testid="stRadio"] > div > div { gap:0 !important; padding:0 !important; margin:0 !important; width:100% !important; }
...
/* Also zero the stVerticalBlock wrapper Streamlit puts around the radio */
[data-testid="stSidebar"] [data-testid="stVerticalBlock"] { padding:0 !important; margin:0 !important; gap:0 !important; }
[data-testid="stSidebar"] [data-testid="stVerticalBlock"] > div { padding:0 !important; margin:0 !important; }

/* Kill the default blue/grey focus ring or highlight bar BaseWeb adds */
[data-testid="stSidebar"] [data-testid="stRadio"] [data-baseweb="radio"] input { display:none !important; }
...
/* selected — all selector variants */
...
[data-testid="stSidebar"] [data-testid="stRadio"] label[data-checked="true"]:hover {
  background: linear-gradient(90deg, #1A5DAB 0%, #0D3F7A 100%) !important;
  color: #FFFFFF !important;
}
...
with st.sidebar:
    ...
    st.markdown("""
    <div style="padding:8px 20px 6px; font-size:8px; font-weight:700;
