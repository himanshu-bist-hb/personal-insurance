...
/* ── SELECTED  — aria-checked is set natively by the browser on the
       checked radio's label; this never fails regardless of Streamlit
       version or CSS class name changes ── */
[data-testid="stSidebar"] [data-testid="stRadio"] label[aria-checked="true"] {
  ...
  box-shadow: 0 3px 12px rgba(13,63,122,0.28) !important;
}
